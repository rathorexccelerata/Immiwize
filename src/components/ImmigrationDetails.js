...
const ImmigrationDetails = () => {
  return (
    <>
      <h1 className="section-title">Immi<span>g</span>ration</h1>
            ...
            <div className="service-bottom">
              ...
              <div className="service-item">
                ...
                <p>
                  ...
                  Right from finding college to the place of living,
              ...
              <div className="service-item">
                ...
                <p>
                  We have reserved many of the job spots reserved for you.
                  We ensure your passion  is under the guidance of experts by choosing
                  the  right path.
                </p>
                <button className="btn btn2">Read More</button>
              </div>
              <div className="service-item">
                ...
                <p>
                  ...
                  we guide you by exploring many other ways to fulfil your
                   dreams by settling down in your dream country with many other options.
                </p>
                <button className="btn btn2">Read More</button>
              </div>
            </div>
